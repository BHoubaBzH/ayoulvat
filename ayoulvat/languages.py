...
text_template['fr_fr']['events_yours_h']        = _("Choisis un évènement pour gérer tes créneaux. ")
...
text_template['fr_fr']['events_not_yours_h']    = _("Evenements disponibles aux quels tu ne participes pas encore. Cliques dessus pour t'y inscrire")
...
text_template['fr_fr']['slot_available_t']      = _("Céneau Disponible, Clique pour t'y inscrire")
...
text_template['fr_fr']['admin_slots_vol_name']  = _('bénévole nom')
text_template['fr_fr']['admin_slots_vol_first'] = _('bénévole prénom')
