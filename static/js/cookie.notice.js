...
(function () {
    ...
    var defaults = {
        'messageLocales': {
            ...
            'fr': 'Nous utilisons des cookies afin d\'être sûr que vous ayez la meilleure expérience sur notre site. Si vous continuez à utiliser ce site, nous supposons que vous acceptez.'
        },
    ...
    function createNotice(message, bgColor, textColor, position) {
        ...
        noticeStyle.left = '0px';
        noticeStyle.right = '0px';
