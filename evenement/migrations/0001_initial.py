    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nom', models.CharField(blank=True, default='', max_length=80)),
                ('debut', models.DateTimeField(default='')),
                ('fin', models.DateTimeField(default='')),
                ('description', models.CharField(blank=True, default='', max_length=500)),
                ('UUID_personne', models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='benevole.profilebenevole')),
                ('UUID_planning', models.ForeignKey(default='', on_delete=django.db.models.deletion.DO_NOTHING, to='evenement.planning')),
            ],
        ),
    ]
